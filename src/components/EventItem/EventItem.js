	...
	render() {
		...
		return (
			<div id="eventItemDiv" onClick={() => this.eventClick(this.props.event)}>
                ...
                <h4 className="centered">{this.props.event.acronym}</h4>
                ...
                <h4 className="centered">{this.props.event.website}</h4>
                <h6 className="centered">Campaign Start</h6>
                    <input
                    ...
                    />
                <h6 className="centered">Campaign End</h6>
                <input
                    className="centeredImage"
                    type='date'
                    name='campaignEnd'
