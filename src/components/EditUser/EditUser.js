	...
	render() {
		...
		return (
			<div id='editUserDiv' className='rounded'>
				<h1 className='centered' id='editUserHeader'>
					Edit User
				</h1>
				<hr />
				<form onSubmit={this.checkURL}>
					<h4 id='editInfoTag' className='centered'>
						First Name
					</h4>
					<input
					...
					<input
						...
						onChange={(event) => this.handleChange(event, "image")}></input>
					...
					<input
						...
						onChange={(event) =>
							this.handleChange(event, "ayrshareapikey")
						}></input>

					<br />
					<button type='submit' className='centeredImage btn-all'>
						Save Changes
					</button>
					<br />
				</form>
				<button className='centeredImage btn-all' onClick={this.navHome}>
					Back
				</button>
				<br />
			</div>
